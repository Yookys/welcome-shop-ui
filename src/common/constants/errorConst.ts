...
export const ErrorTextsOfCodes: Record<EErrorStatus, string | undefined> = {
  ...
  [EErrorStatus._403]:
    'У вас не достаточно прав. Для получения доступа, обратитесь к своему администратору или супервайзеру',
  [EErrorStatus._404]: 'Ошибка на сервере. Для получения информации, обратитесь к своему администратору',
  [EErrorStatus._500]: 'Функционал не выполняется. Ошибка на сервере. Попробуйте обновить страницу',
  [EErrorStatus._503]: 'Функционал временно недоступен. Обновляем систему. Не волнуйтесь, это плановые работы',
};
