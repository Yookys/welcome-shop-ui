...
/**
 * Безопасный перевод строки в нижний регистр
 * @param value - Строка
 */
export const safeLowerCaseString = (value: any) => (value.toString() || '').toLowerCase();
 ...
 * @param isDebug - Включен ли дебаг
 */
export const debug = (data: {message: any; optionalParams?: any[]}, type?: DebugTypes, isDebug?: boolean) => {
